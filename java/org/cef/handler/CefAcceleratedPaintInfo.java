...
/**
 * Base structure representing accelerated paint info.
 *
 * <p>The underlying shared resource is owned by CEF and may be recycled once
 * the callback returns. Applications should import or copy the resource during
 * the callback and avoid caching these raw handles long-term.
 */
