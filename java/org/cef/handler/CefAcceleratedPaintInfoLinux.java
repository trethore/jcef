...
/**
 * Linux-specific accelerated paint info.
 */
public class CefAcceleratedPaintInfoLinux extends CefAcceleratedPaintInfo {
    ...
    public boolean hasDmaBufPlanes() {
        return plane_count > 0 && plane_fds != null && plane_strides != null
                && plane_offsets != null && plane_sizes != null;
    }

    @Override
    public CefAcceleratedPaintInfoLinux clone() {
        CefAcceleratedPaintInfoLinux clone =
                new CefAcceleratedPaintInfoLinux(format, width, height);
